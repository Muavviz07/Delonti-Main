        ...
        <section id="contact" className="py-24 bg-gray-50 dark:bg-[#16161c]">
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        <h2 className="text-sm font-semibold uppercase tracking-[0.25em] text-[#6366f1] mb-4">
                            Contact Us
                        </h2>
                        ...
                        <form className="space-y-6 relative z-10">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input suppressHydrationWarning type="text" className="w-full bg-gray-50 dark:bg-slate-900/50 border border-gray-100 dark:border-white/10 rounded-xl p-4 text-sm focus:ring-2 focus:ring-[#6366f1] focus:border-transparent outline-none dark:text-white transition-all" placeholder="John Doe" />
                                </div>
                                <div>
                                    <label className="block text-xs font-semibold text-slate-500 uppercase tracking-widest mb-2">Email</label>
                                    <input suppressHydrationWarning type="email" className="w-full bg-gray-50 dark:bg-slate-900/50 border border-gray-100 dark:border-white/10 rounded-xl p-4 text-sm focus:ring-2 focus:ring-[#6366f1] focus:border-transparent outline-none dark:text-white transition-all" placeholder="john@example.com" />
                                </div>
                            </div>
                            <div>
                                <label className="block text-xs font-semibold text-slate-500 uppercase tracking-widest mb-2">Inquiry Type / Sector</label>
                                <select suppressHydrationWarning className="w-full bg-gray-50 dark:bg-slate-900/50 border border-gray-100 dark:border-white/10 rounded-xl p-4 text-sm focus:ring-2 focus:ring-[#6366f1] focus:border-transparent outline-none dark:text-white appearance-none transition-all cursor-pointer">
                            ...
                            <div>
                                ...
                                <textarea suppressHydrationWarning className="w-full bg-gray-50 dark:bg-slate-900/50 border border-gray-100 dark:border-white/10 rounded-xl p-4 text-sm focus:ring-2 focus:ring-[#6366f1] focus:border-transparent outline-none dark:text-white h-32 resize-none transition-all" placeholder="How can we help?"></textarea>
                            </div>
                            <button suppressHydrationWarning className="w-full bg-[#6366f1] hover:bg-[#4f46e5] text-white font-semibold uppercase tracking-widest py-4 rounded-xl transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5">
                                Send Message
                            </button>
                        </form>
                    </div>
