        ...
        <section id="contact" className="py-24 bg-white dark:bg-slate-950 border-t border-slate-100 dark:border-white/5">
            <div className="max-w-[1400px] mx-auto px-8 sm:px-16 lg:px-24">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center gap-5 group">
                                ...
                                <div>
                                    <p className="text-xs font-semibold text-slate-400 uppercase tracking-widest mb-1">Headquarters</p>
                    ...
                    <div className="bg-white dark:bg-slate-900/50 p-8 md:p-10 rounded-xl shadow-xl border border-gray-150 dark:border-white/5 relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-64 h-64 bg-primary/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />

                        {submitted ? (
                            <div className="relative z-10 text-center py-12 flex flex-col items-center justify-center">
                                ...
                                <p className="text-slate-500 dark:text-slate-400 text-sm max-w-sm leading-relaxed mb-8 font-medium">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-gray-50 dark:bg-slate-950 border border-gray-150 dark:border-white/10 rounded-xl p-4 text-sm focus:ring-2 focus:ring-primary focus:border-transparent outline-none dark:text-white transition-all"
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label className="block text-xs font-semibold text-slate-500 uppercase tracking-widest mb-2">Company / Org</label>
                                        <input
                                            type="text"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="w-full bg-gray-50 dark:bg-slate-950 border border-gray-150 dark:border-white/10 rounded-xl p-4 text-sm focus:ring-2 focus:ring-primary focus:border-transparent outline-none dark:text-white h-32 resize-none transition-all"
