...
export default function Hero() {
  return (
    <section className="relative w-full h-screen min-h-[600px] md:min-h-[800px] overflow-hidden bg-[#0a0a0f]">
      {/* Background Video */}
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-linear-to-r from-[#0a0a0f]/70 via-[#0a0a0f]/30 to-transparent" />
      ...
      <div className="relative z-10 container mx-auto h-full flex flex-col justify-center px-4 sm:px-10 md:px-16 lg:px-24">
        ...
        >
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 mb-6 md:mb-8 text-[10px] md:text-sm font-bold tracking-0.1em md:tracking-[0.2em] text-blue-400 uppercase bg-blue-500/10 border border-blue-500/20 rounded-full backdrop-blur-sm"
          >
            <span className="relative flex h-2 w-2">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-blue-400 opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2 w-2 bg-blue-500"></span>
            </span>
            RFID • IoT • Cybersecurity • Data Platforms
          </motion.div>
          ...
          <motion.h1 
            ...
            className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-black mb-6 md:mb-8 tracking-tight leading-[1.1] md:leading-[0.95] wrap-break-word"
          >
            REAL-TIME <br />
            <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-400 to-indigo-500">VISIBILITY ACROSS</span> <br />
            INFRASTRUCTURE
          </motion.h1>
          ...
          <motion.p 
            ...
            className="text-base md:text-2xl text-slate-300 mb-10 md:mb-12 leading-relaxed max-w-2xl font-light"
          >
            Government Infrastructure is Complex and it is difficult to manage operations with limited visibility across assets. Delonti provides Secure Intelligent Infrastructure Solutions
          </motion.p>
          ...
          >
            ...
            >
              ...
              <span className="relative z-10 uppercase tracking-wider text-xs md:text-sm">Explore Public Sector</span>
            ...
            >
              <span className="uppercase tracking-wider text-xs md:text-sm">Explore Private Sector</span>
