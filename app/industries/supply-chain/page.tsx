...
import {
  ...
  Globe, ArrowRight, Zap, ChevronRight, ChevronLeft, Play, ShoppingCart, BarChart3, RefreshCw
} from "lucide-react";
...
export default function SupplyChainIndustryPage() {
  ...
  const useCases = [
    { title: "Warehouse Asset Management", img: IMAGES.case_warehouse, href: "/resources/case-studies/warehouse-asset-management" },
    { title: "Real-Time Distribution Center Inventory", img: IMAGES.case_distribution, href: "/resources/case-studies/real-time-distribution-center-inventory" },
    { title: "Omnichannel Retail Fulfillment", img: IMAGES.case_retail, href: "/resources/case-studies/omnichannel-retail-fulfillment" },
    { title: "Carrier Logistics Visibility", img: IMAGES.case_logistics, href: "/resources/case-studies/carrier-logistics-visibility" },
    { title: "Reverse Logistics Optimization", img: IMAGES.case_reverse, href: "/resources/case-studies/reverse-logistics-optimization" }
  ];
  ...
  return (
    <main className="w-full bg-[#FAFAFA] dark:bg-background-dark font-sans selection:bg-[#2b2b4f] selection:text-white relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            >
              ...
              >
                ...
                <span className="text-primary dark:text-blue-400">Intelligent Supply Chains</span>
              </motion.h1>
      ...
      <section className="py-16 lg:py-20 bg-[#FAFAFA] dark:bg-background-dark-alt border-y border-slate-200 dark:border-slate-800">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12 lg:mb-16 text-center max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tighter mb-4 text-[#111111] dark:text-white uppercase">A Platform Approach to Supply Chain Infrastructure</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div key={idx} className="flex flex-col items-center justify-center p-6 rounded-2xl bg-white/5 border border-white/5 backdrop-blur-xs">
                ...
                <span className="text-xs md:text-sm font-bold tracking-wider text-blue-400 uppercase text-center">{stat.label}</span>
              </div>
            ))}
          </div>
        </div>
