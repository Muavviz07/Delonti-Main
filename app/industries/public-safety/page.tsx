...
import {
  ...
  Globe, ArrowRight, Zap, ChevronRight, ChevronLeft, Play, HeartPulse, UserCheck, Shield
} from "lucide-react";
...
export default function PublicSafetyIndustryPage() {
  ...
  const useCases = [
    { title: "Law Enforcement Fleet & Asset Management", img: IMAGES.case_law, href: "/resources/case-studies/law-enforcement-fleet-asset-management" },
    { title: "Emergency Medical Services Readiness", img: IMAGES.case_emergency, href: "/resources/case-studies/emergency-medical-services-readiness" },
    { title: "Fire & Rescue Equipment Tracking", img: IMAGES.case_equipment, href: "/resources/case-studies/fire-rescue-equipment-tracking" },
    { title: "Public Facility Security Monitoring", img: IMAGES.case_facility, href: "/resources/case-studies/public-facility-security-monitoring" },
    { title: "Community Safety Monitoring", img: IMAGES.case_safety, href: "/resources/case-studies/community-safety-monitoring" }
  ];
  ...
  return (
    <main className="w-full bg-[#FAFAFA] dark:bg-background-dark font-sans selection:bg-[#2b2b4f] selection:text-white relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            >
              ...
              >
                ...
                <span className="text-primary dark:text-blue-400">Public Safety Operations</span>
              </motion.h1>
      ...
      <section className="py-16 lg:py-20 bg-[#FAFAFA] dark:bg-background-dark-alt border-y border-slate-200 dark:border-slate-800">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12 lg:mb-16 text-center max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tighter mb-4 text-[#111111] dark:text-white uppercase">A Platform Approach to Public Safety Infrastructure</h2>
