  ...
  return (
    <main className="w-full bg-[#FAFAFA] font-sans selection:bg-[#2b2b4f] selection:text-white relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            >
              ...
              >
                ...
                <span className="text-primary">Smart Campus Infrastructure</span>
              </motion.h1>
      ...
      <section className="py-16 lg:py-20 bg-[#FAFAFA] border-y border-slate-200">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12 lg:mb-16 text-center max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tighter mb-4 text-[#111111] uppercase">A Platform Approach to Smart Campus Infrastructure</h2>
            <p className="text-sm md:text-base text-slate-500 leading-relaxed font-medium">Delonti connects campus infrastructure to digital intelligence using RFID sensing, IoT connectivity, and AI-powered analytics.</p>
          </div>
