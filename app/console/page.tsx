    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-[#0f172a]">
            ...
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <h2 className="font-display text-3xl font-bold text-slate-900 dark:text-white">Console Dashboard</h2>
                <p className="text-slate-500 dark:text-slate-400 text-sm mt-1 mb-12">Select a section to manage.</p>

                <div className={`grid grid-cols-1 ${showAll ? 'md:grid-cols-2 lg:grid-cols-4' : 'md:grid-cols-2'} gap-6`}>
                    {/* Careers Card */}
                    <Link href="/console/careers" className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-white/10 p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group cursor-pointer block">
                    ...
                    {showAll && (
                        <>
                            {/* Blogs Card */}
                            <Link href="/console/blogs" className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-white/10 p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group cursor-pointer block">
                                <div className="w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center mb-6">
                            ...
                            {/* Articles Card */}
                            <Link href="/console/articles" className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-white/10 p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group cursor-pointer block">
                                <div className="w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center mb-6">
                    ...
                    {/* Settings Card */}
                    <Link href="/console/settings" className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-white/10 p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group cursor-pointer block">
                        <div className="w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center mb-6">
                            <Shield className="w-10 h-10 text-primary" />
                        </div>
                        <h3 className="font-display text-2xl font-bold text-slate-900 dark:text-white">Security</h3>
                        <p className="text-slate-500 dark:text-slate-400 text-sm mt-2">Update console password and configure security.</p>
