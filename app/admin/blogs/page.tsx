...
export default function BlogAdminPage() {
    ...
    const [form, setForm] = useState<any>(emptyBlogForm)
    ...
    const fetchPosts = useCallback(async () => {
        ...
        try {
            ...
            setCategories(catsData.categories || [
                "RFID & Asset Tracking", "IoT & Smart Infrastructure",
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-[#0f172a]">
                ...
                <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-400">Blog Management</p>
                        </div>
                    </div>
            ...
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="mb-8">
                    <h2 className="text-3xl font-bold text-slate-900 dark:text-white font-display mb-1">Blog Management</h2>
                    <p className="text-slate-500 dark:text-slate-400 text-sm">Create, edit, and manage blog posts.</p>
                </div>
                ...
                <div className="mt-12 bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-white/10 p-6 shadow-sm">
                    <h3 className="text-xs font-bold uppercase tracking-widest text-slate-500 mb-6">Manage Blog Categories</h3>
                        ...
                        <form onSubmit={handleSave} className="p-6 space-y-5">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-400 mt-1">
                                    URL: /resources/blogs/{generateContentSlug(form.title || '')}
                                </p>
                            </div>
                            ...
                            <div className="pt-4 border-t border-gray-100 dark:border-white/10">
                                <button type="submit" disabled={saving} className="w-full bg-[#2b2b4f] hover:bg-[#2b2b4f]/90 disabled:opacity-60 text-white font-bold uppercase tracking-widest py-3.5 rounded-xl transition-all flex items-center justify-center gap-2">
                                    {saving ? <><Loader2 className="w-4 h-4 animate-spin" /> Saving...</> : <><Check className="w-4 h-4" /> {editingPost ? "Save Post" : "Create Post"}</>}
                                </button>
                            </div>
                        </form>
                    </div>
            ...
            {confirmDelete && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative bg-white dark:bg-slate-900 rounded-2xl p-6 max-w-sm w-full shadow-2xl border border-gray-100 dark:border-white/10">
                        <h3 className="text-lg font-bold text-slate-900 dark:text-white font-display mb-2">Delete this post?</h3>
