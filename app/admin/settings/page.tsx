        ...
        <div className="min-h-screen bg-slate-50 dark:bg-[#0f172a]">
            ...
            <div className="bg-white dark:bg-slate-900 border-b border-gray-100 dark:border-white/10 sticky top-0 z-40">
                <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-6">
                        <Link href="/admin" className="text-sm font-semibold text-slate-500 dark:text-slate-400 hover:text-[#2b2b4f] dark:hover:text-white flex items-center gap-1.5 transition-colors">
            ...
            <div className="max-w-2xl mx-auto px-4 sm:px-6 py-12">
                <div className="mb-8">
                    ...
                    <p className="text-slate-500 dark:text-slate-400 text-sm">Update the administrative password for accessing the portal.</p>
                </div>
