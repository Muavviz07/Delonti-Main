...
import {
  ...
  Cpu, Wrench, Shield, CheckCircle2, AlertTriangle, Users,
  MapPin, ShieldCheck, AlertOctagon, Thermometer, Ban, UserCheck, Bell, BarChart3,
  Tag, Cloud, Brain
} from "lucide-react";
import Header from "@/components/Header";
import Footer from "@/components/Footer";

export default function WorkforceSafetySolutionPage() {
  ...
  const useCases = [
    {
      title: "Manufacturing Workforce Tracking",
      img: "/images/public-safety/public_safety_case_safety.png",
      href: "/resources/case-studies/manufacturing-workforce-tracking",
      overview: "Manufacturing facilities often operate in complex environments where worker visibility, restricted area monitoring, and safety compliance are critical to maintaining safe and productive operations. Delonti provides real-time workforce visibility to improve safety and operational awareness.",
      benefits: ["Visibility", "Utilization", "Efficiency", "Compliance"]
    },
    {
      title: "Construction Safety Management",
      img: "/images/public-safety/public_safety_case_equipment.png",
      href: "/resources/case-studies/construction-safety-management",
      overview: "Construction projects involve constantly changing work environments, multiple contractors, and numerous safety risks that require proactive monitoring and management. Delonti enables construction organizations to monitor personnel and improve job-site safety in real time.",
      benefits: ["Visibility", "Utilization", "Efficiency", "Compliance"]
    },
    {
      title: "Public Safety Operations",
      img: "/images/public-safety/public_safety_case_emergency.png",
      href: "/resources/case-studies/emergency-response-coordination",
      overview: "Police departments, fire services, EMS organizations, and emergency management agencies require real-time visibility into personnel and resources during routine operations and emergency incidents. Delonti provides situational awareness and operational intelligence for public safety organizations.",
      benefits: ["Visibility", "Utilization", "Efficiency", "Compliance"]
    },
    {
      title: "Campus Safety Monitoring",
      img: "/images/education/education_case_safety.png",
      href: "/resources/case-studies/campus-safety-monitoring",
      overview: "Educational institutions require greater visibility into campus environments to improve safety, support emergency response, and maintain operational awareness across facilities. Delonti helps educational organizations create safer and smarter campuses through real-time monitoring and workforce visibility.",
      benefits: ["Visibility", "Utilization", "Efficiency", "Compliance"]
    }
  ];
    ...
    <main className="w-full bg-[#FAFAFA] dark:bg-background-dark font-sans selection:bg-logo selection:text-white relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-6 tracking-tighter leading-[1.1] text-slate-900 dark:text-white uppercase">
                Workforce Safety & <br />
                <span className="text-logo dark:text-blue-400">Real-Time Visibility</span>
              </h1>

              <p className="text-sm md:text-base text-slate-500 dark:text-slate-400 mb-10 leading-relaxed max-w-xl font-medium">
                Track personnel movement and improve safety across facilities and operations.
              </p>
            ...
            >
              <img
                src="/images/solutions/workforce_safety_hero.png"
                alt="Workforce Safety and Visibility"
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12 lg:mb-16 text-center max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tighter text-slate-900 dark:text-white uppercase">
              Why Workforce Safety Is a Challenge
            </h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { title: "Limited Movement Visibility", desc: "Limited visibility into workforce movement across departments." },
              { title: "Complex Safety Risks", desc: "Safety risks in complex and hazardous environments." },
              { title: "Slow Response Times", desc: "Slow emergency response due to localization gaps." },
              { title: "Lack of Tracking", desc: "Lack of real-time tracking for active personnel on-site." }
            ].map((prob, i) => (
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-black tracking-tighter text-slate-900 dark:text-white uppercase mb-6 leading-tight">
              RFID + IoT-Powered Workforce Safety Platform
            </h2>
            <p className="text-sm md:text-base lg:text-lg text-slate-500 dark:text-slate-400 leading-relaxed font-medium">
              Delonti enables workforce tracking and safety monitoring using RFID and IoT.
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-stretch justify-between gap-4 relative">
            {[
              { step: "Wearables / Tags", desc: "Affixed to staff badges & safety gear", icon: Tag },
              { step: "Sensors", desc: "Scan location signal access points", icon: Radio },
              { step: "Platform", desc: "Secure central database engine", icon: Cloud },
              { step: "Alerts", desc: "Instant zone or emergency notifications", icon: Bell }
            ].map((node, idx, arr) => {
      ...
      <section className="py-16 lg:py-20 bg-white dark:bg-background-dark">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-row md:grid md:grid-cols-5 gap-4 md:gap-6 overflow-x-auto no-scrollbar pb-4 md:pb-0 snap-x snap-mandatory">
            {[
              { title: "Personnel Tracking", desc: "Monitor staff movement and locations across sites." },
              { icon: Cpu, title: "Safety Alerts", desc: "Automated triggers for SOS, zone breaches, or man-down events." },
              { icon: Wrench, title: "Location Monitoring", desc: "Zonal accuracy monitoring for geofenced sections." },
              { icon: Shield, title: "Incident Tracking", desc: "Maintain secure incident registers for safety reports." },
              { icon: Monitor, title: "Real-Time Visibility", desc: "Live mapping of all active personnel in the command center." }
            ].map((cap, i) => {
              const subtleThemes = [
                {
      ...
      <section className="py-16 lg:py-20 bg-slate-50/50 dark:bg-background-dark-alt border-t border-slate-200/60 dark:border-slate-800">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { val: "Improve Safety", desc: "Optimize employee protection patterns across facilities." },
              { val: "Faster Response", desc: "Reduce localization gaps to dispatch help inside seconds." },
              { val: "Better Coordination", desc: "Unified dashboards sync team alerts automatically." },
              { val: "Increased Compliance", desc: "Meet strict safety guidelines with automatic movement audits." }
            ].map((benefit, idx) => (
      ...
      <section className="py-16 lg:py-20 bg-white dark:bg-background-dark border-t border-slate-200/60 dark:border-slate-800">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { label: "Worker Location", icon: MapPin },
              { label: "PPE Compliance", icon: ShieldCheck },
              { label: "SOS / Man-Down Alerts", icon: AlertOctagon },
              { label: "Environmental Conditions", icon: Thermometer },
              { label: "Restricted Areas", icon: Ban },
              { label: "Contractors & Visitors", icon: UserCheck },
              { label: "Emergency Notifications", icon: Bell },
              { label: "Workforce Analytics", icon: BarChart3 }
            ].map((mon, idx) => {
      ...
      <section className="py-16 bg-slate-900 text-white border-t border-slate-855 relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-6 text-center">
            {[
              { val: "✔", label: "Improved Safety" },
              { val: "✔", label: "Faster Response" },
              { val: "✔", label: "Enhanced Compliance" },
              { val: "✔", label: "Reduced Incidents" },
              { val: "✔", label: "Accountability" },
              { val: "✔", label: "Real-Time Awareness" },
              { val: "✔", label: "Incident Management" },
              { val: "✔", label: "Stronger Safety Culture" }
            ].map((stat, idx) => (
              <div key={idx} className="flex flex-col items-center justify-center p-4 rounded-xl bg-white/5 border border-white/5 backdrop-blur-xs">
                <span className="text-xl md:text-2xl font-black text-logo dark:text-blue-400 mb-1 uppercase tracking-tight">{stat.val}</span>
                <span className="text-[10px] font-bold tracking-wider text-slate-350 uppercase text-center">{stat.label}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative py-16 lg:py-20 bg-[#111111] text-white overflow-hidden border-t border-[#2b2b4f]">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tighter mb-4 max-w-3xl leading-tight uppercase">
            Protect Your Workforce with Real-Time Intelligence
          </h2>
          <p className="text-sm md:text-base text-slate-400 mb-8 max-w-2xl font-medium">
            Delonti's RFID + AI platform helps organizations monitor workforce activity, improve safety, and respond faster to critical events.
          </p>
